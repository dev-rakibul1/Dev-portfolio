...
const About = () => {
  ...
  return (
    <Box className="about-glass">
      <Box
        sx={{ pt: 14, backgroundColor: "transparent" }}
        className="about-manage"
      >
        <Typography
          variant="span"
          sx={{
            ...
            >
              ...
              <CardContent sx={{ color: "#fff" }}>
                ...
                >
                  ...
                  back. Passionate about learning new technologies, bringing
                  ideas to life, and working with dedicated terms to build
                  effective and robust applications suitable to the user's
                  needs.
                </Typography>
                ...
                >
                  ...
                  <span>
                    <strong>Responsive design</strong> – Flexbox, Grid,
